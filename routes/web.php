...
Route::middleware('auth')->group(function () {
    ...
    Route::patch('/nota/{nota}/void',        [NotaController::class, 'void'])->name('nota.void');
    Route::post('/nota/kembali-edit', [NotaController::class, 'kembaliEdit'])->name('nota.kembaliEdit');
});